...
const handleScan = async (e) => {
  ...
  // --- Rendu du Composant (corrigé) ---

  return (
    // 1. Conteneur principal: min-h-screen et flex-col pour Header/Main
    <div className="min-h-screen bg-gray-50 flex flex-col">
        {/* Assurez-vous de passer les props nécessaires au Header */}
        <Header notifications={notifications || 0} /> 
    
        {/* 2. Conteneur pour Sidebar et Contenu Principal: flex-row */}
              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200">
                  <div className="p-6 border-b border-gray-200">
                    <h3 className="text-xl font-bold text-gray-900">Pointages d'aujourd'hui</h3>
                  </div>
                  <div className="p-6">
                          ...
                          >
                            ...
                            <div className="text-right">
                              ...
                              <span className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${getStatutColor(scan.statut)}`}>
                                {scan.statut === 'PRESENT' ? 'À l\'heure' : 'En retard'}
                              </span>
                            </div>
                          </div>
                        ))}
