...
export default function UserList({notifications, activeLink, setActiveLink}) {
    ...
    const getStatutFromBoolean = (estActif) => {
    ...
    const getStatutColor = (estActif) => {
        ...
        switch(statut) {
            ...
            case 'inactif': return 'bg-gray-100 text-red-800 border-red-200';
            default: return 'bg-gray-100 text-gray-800 border-gray-200';
        }
    };
  
    const handleToggleStatut = async (id, estActif) => {
        console.log("Toggle statut pour ID:", id, "estActif:", estActif);
                                ...
                                {!loading && filteredUsers.length === 0 && (
                                    <tr>
                                        <td colSpan="5" className="px-6 py-8 text-center text-gray-500 text-sm">
                                            {searchTerm ? 
                                                `Aucun utilisateur trouvé pour la recherche "${searchTerm}".` :
